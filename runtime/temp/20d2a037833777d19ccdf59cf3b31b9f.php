<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"/www/wwwroot/pt.jinniupaid.com/public/../application/user/view/general/profile/index.html";i:1596299640;s:72:"/www/wwwroot/pt.jinniupaid.com/application/user/view/layout/default.html";i:1588765312;s:69:"/www/wwwroot/pt.jinniupaid.com/application/user/view/common/meta.html";i:1588765312;s:71:"/www/wwwroot/pt.jinniupaid.com/application/user/view/common/script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="box box-success">
            ...
            <div class="panel-body">
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.profile/update'); ?>">
                    <?php echo token(); ?>
                    <input type="hidden" id="c-avatar" name="row[avatar]" value="<?php echo htmlentities($user['avatar']); ?>"/>
                    <div class="box-body box-profile">

                        <div class="profile-avatar-container">
                            <img class="profile-user-img img-responsive img-circle plupload" src="<?php echo htmlentities(cdnurl($user['avatar'])); ?>" alt="">
                        ...
                        <h3 class="profile-username text-center"><?php echo htmlentities($user['username']); ?></h3>

                        <div class="form-group">
                            <label for="username" class="control-label"><?php echo __('Username'); ?>:</label>
                            <input type="text" class="form-control" id="username" name="row[username]" value="<?php echo htmlentities($user['username']); ?>" disabled/>
                        </div>

                        <div class="form-group">
                            <label for="nickname" class="control-label"><?php echo __('Nickname'); ?>:</label>
                            <input type="text" class="form-control" id="nickname" name="row[nickname]" value="<?php echo htmlentities($user['nickname']); ?>" data-rule="required"/>
                        </div>
                        <div class="form-group">
