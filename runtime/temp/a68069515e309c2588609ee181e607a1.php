<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:79:"/www/wwwroot/pt.jinniupaid.com/public/../application/user/view/index/index.html";i:1588765312;s:69:"/www/wwwroot/pt.jinniupaid.com/application/user/view/common/meta.html";i:1588765312;s:71:"/www/wwwroot/pt.jinniupaid.com/application/user/view/common/header.html";i:1596293508;s:69:"/www/wwwroot/pt.jinniupaid.com/application/user/view/common/menu.html";i:1596293772;s:72:"/www/wwwroot/pt.jinniupaid.com/application/user/view/common/control.html";i:1588765312;s:71:"/www/wwwroot/pt.jinniupaid.com/application/user/view/common/script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo htmlentities(cdnurl($user['avatar'])); ?>" class="user-image" alt="<?php echo htmlentities($user['nickname']); ?>">
                        <span class="hidden-xs"><?php echo htmlentities($user['nickname']); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?php echo htmlentities(cdnurl($user['avatar'])); ?>" class="img-circle" alt="">

                            <p>
                                <?php echo htmlentities($user['nickname']); ?>
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="<?php echo htmlentities(cdnurl($user['avatar'])); ?>" class="img-circle" /></a>
        </div>
