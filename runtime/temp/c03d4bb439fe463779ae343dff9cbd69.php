<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"E:\phpstudy_pro\WWW\daifuagent\public/../application/admin\view\index\login.html";i:1602485026;s:70:"E:\phpstudy_pro\WWW\daifuagent\application\admin\view\common\meta.html";i:1588765312;s:72:"E:\phpstudy_pro\WWW\daifuagent\application\admin\view\common\script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="container">
            <div class="login-wrapper">
                <div class="login-screen">
                    <div style="color: #ffffff;text-align: center;margin-bottom: 20px;"><h2><?php echo $site['name']; ?></h2></div>
                    <div class="well">
                        <div class="login-form">
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <?php endif; if(\think\Config::get('fastadmin.login_checkadmingoogle')): ?>
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></div>
