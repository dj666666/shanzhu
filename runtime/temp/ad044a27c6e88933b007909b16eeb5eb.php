<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"/home/wwwroot/pt.jinniupaid.com/public/../application/admin/view/dashboard/index.html";i:1596522408;s:74:"/home/wwwroot/pt.jinniupaid.com/application/admin/view/layout/default.html";i:1588765312;s:71:"/home/wwwroot/pt.jinniupaid.com/application/admin/view/common/meta.html";i:1588765312;s:73:"/home/wwwroot/pt.jinniupaid.com/application/admin/view/common/script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
                                ...
                                <div class="row row-sm stats-container">
                                   ...
                                   <!-- <div class="col-xs-12 stat-col">
                                    ...
                                    <div class="col-xs-4 stat-col">
                                        ...
                                        <span class="sm-st-icon st-violet"><i class="fa fa-book"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $all_money; ?></div>
                                            <div class="name"> <?php echo __('总额'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-4  stat-col">
                                        ...
                                        <span class="sm-st-icon st-violet"><i class="fa fa-book"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $all_order; ?></div>
                                            <div class="name"> <?php echo __('总订单'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-4  stat-col">
                                        ...
                                        <span class="sm-st-icon st-violet"><i class="fa fa-book"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $all_faile; ?></div>
