<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:88:"/home/wwwroot/pt.jinniupaid.com/public/../application/merchant/view/dashboard/index.html";i:1598537297;s:77:"/home/wwwroot/pt.jinniupaid.com/application/merchant/view/layout/default.html";i:1588765312;s:74:"/home/wwwroot/pt.jinniupaid.com/application/merchant/view/common/meta.html";i:1588765312;s:76:"/home/wwwroot/pt.jinniupaid.com/application/merchant/view/common/script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
                            ...
                            <div class="card-block">
                                <div class="row row-sm stats-container">
                                    ...
                                    <div class="col-xs-4  stat-col">
                                        ...
                                        <div class="stat">
                                        	<div class="name"> <?php echo __('今日手续费'); ?></div>
                                            <div class="value"> <?php echo $today_fees; ?></div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4  stat-col">
                                        ...
                                        <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $yesterday_fees; ?></div>
                                            <div class="name"> <?php echo __('昨日手续费'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4  stat-col">
                                        ...
                                        <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $all_fees; ?></div>
                                            <div class="name"> <?php echo __('总手续费'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-4  stat-col">
                                        ...
                                        <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                                        <div class="stat">
                                        	<div class="name"> <?php echo __('今日总额'); ?></div>
                                            <div class="value"> <?php echo $today_money; ?></div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4  stat-col">
                                       <div class="stat-icon"><!-- <i class="fa fa-list-alt"></i>--></div>
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo $today_order; ?></div>
                                    ...
                                    <div class="col-xs-4  stat-col">
                                        <div class="stat-icon"><!--<i class="fa fa-line-chart">--></i></div>
                                        <span class="sm-st-icon st-green"><i class="fa fa-warning"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $today_faile; ?></div>
                                            <div class="name"> <?php echo __('今日失败订单'); ?></div>
                                        </div>
                                    ...
                                    <div class="col-xs-4 stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo $yesterday_money; ?></div>
                                            <div class="name"> <?php echo __('昨日总额'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4  stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo $yesterday_order; ?></div>
                                            <div class="name"> <?php echo __('昨日订单'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4  stat-col">
                                        <div class="stat-icon"><!--<i class="fa fa-users"></i>--></div>
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo $yesterday_faile; ?></div>
                                            <div class="name"> <?php echo __('昨日失败订单'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-4 stat-col">
                                        <div class="stat-icon"><!--<i class="fa fa-shopping-cart"></i>--></div>
                                        <span class="sm-st-icon st-blue"><i class="fa fa-cny"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $all_success_money; ?></div>
                                            <div class="name"> <?php echo __('总成功金额'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4  stat-col">
                                        <div class="stat-icon"><!--<i class="fa fa-users"></i>--></div>
                                        <span class="sm-st-icon st-blue"><i class="fa fa-shopping-bag"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $all_success_order; ?></div>
                                            <div class="name"> <?php echo __('总成功订单'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4  stat-col">
                                        <div class="stat-icon"><!--<i class="fa fa-users"></i>--></div>
                                        <span class="sm-st-icon st-blue"><i class="fa fa-warning"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $all_fail_order; ?></div>
                                            <div class="name"> <?php echo __('总失败订单'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-4 stat-col">
                                        ...
                                        <div class="stat">
                                            ...
                                            <div class="name"> <?php echo __('可用余额'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-4 stat-col">
                                        ...
                                        <span class="sm-st-icon st-red"><i class="fa fa-cny"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $blocking; ?></div>
                                            <div class="name"> <?php echo __('冻结金额'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-4 stat-col">
                                        ...
                                        <span class="sm-st-icon st-red"><i class="fa fa-cny"></i></span>
                                        <div class="stat">
                                            <div class="value"> <?php echo $kydj; ?></div>
                                            <div class="name"> <?php echo __('可用+冻结'); ?></div>
                                        </div>
                                    </div>
