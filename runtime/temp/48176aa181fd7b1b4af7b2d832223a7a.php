<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:84:"/home/wwwroot/pt.jinniupaid.com/public/../application/merchant/view/index/index.html";i:1588765312;s:74:"/home/wwwroot/pt.jinniupaid.com/application/merchant/view/common/meta.html";i:1588765312;s:76:"/home/wwwroot/pt.jinniupaid.com/application/merchant/view/common/header.html";i:1596607192;s:74:"/home/wwwroot/pt.jinniupaid.com/application/merchant/view/common/menu.html";i:1596607640;s:77:"/home/wwwroot/pt.jinniupaid.com/application/merchant/view/common/control.html";i:1588765312;s:76:"/home/wwwroot/pt.jinniupaid.com/application/merchant/view/common/script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo htmlentities(cdnurl($merchant['avatar'])); ?>" class="user-image" alt="<?php echo htmlentities($merchant['nickname']); ?>">
                        <span class="hidden-xs"><?php echo htmlentities($merchant['nickname']); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?php echo htmlentities(cdnurl($merchant['avatar'])); ?>" class="img-circle" alt="">

                            <p>
                                <?php echo htmlentities($merchant['nickname']); ?>
                                <small><?php echo date("Y-m-d H:i:s",$merchant['logintime']); ?></small>
                            </p>
                        </li>
                        <!-- Menu Footer-->
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="<?php echo htmlentities(cdnurl($merchant['avatar'])); ?>" class="img-circle" /></a>
        </div>
        <div class="pull-left info">
            <p><?php echo htmlentities($merchant['nickname']); ?></p>
