...
class Order extends Model
{
    ...
    {
        return $this->belongsTo('app\agent\model\Agent', 'agent_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }*/


    public function merchant()
    {
        return $this->belongsTo('app\agent\model\Merchant', 'mer_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }


    public function user()
    {
        return $this->belongsTo('app\agent\model\User', 'user_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
}
