 ...
 */
class Crontab extends AgentBackend
{
    ...
    public function _initialize()
    {
        ...
        $this->view->assign('typeList', \app\agent\model\Crontab::getTypeList());
        $this->assignconfig('typeList', \app\agent\model\Crontab::getTypeList());
    }
