 ...
 */
class Crontab extends MerchantBackend
{
    ...
    public function _initialize()
    {
        ...
        $this->view->assign('typeList', \app\merchant\model\Crontab::getTypeList());
        $this->assignconfig('typeList', \app\merchant\model\Crontab::getTypeList());
    }
